...
function Welcome() {
  ...
  <label className='label1' for="value-1">تسجيل  الطلاب</label>
  <input value="value-2" name="value-radio" id="value-2" type="radio" />
  <label className='label1' for="value-2">تسجيل  المعلمين</label>
  <input value="value-3" name="value-radio" id="value-3" type="radio" />
  <label className='label1' for="value-3"> تسجيل ولي الأمر</label>
  <input value="value-4" name="value-radio" id="value-4" type="radio" />
  <label className='label1' for="value-4">تسجيل  المدير</label>
  
</div>
           <nav>
             <img className='logo' src='src\assets\logoNew.png' alt='logoImage' />
             <ul className='menu'>
                 <li><a href='#'>Home</a></li>
                 <li><a href='#'>about us </a></li>
                 <li><a href='#'>service</a></li>
                 <li><a className='phoneContact' href='#'>contact us</a></li>
             </ul>

             </nav>
          <video style={{width:"100%"}}  autoPlay loop muted playsInline className='backgroundVedio'>
            <source  src='vedio/WelcomePage.mp4' type='video/mp4' />
          </video>
  ...
  <span className="tooltip">تفوَّق</span>
  <span className="text">ابدا الان</span>
